...
public interface ProductMapper {
	...
	//@Select("SELECT * FROM PRODUCT P JOIN PRODUCT_PRICE R ON R.PRODUCT_ID = P.ID JOIN PRODUCT_REVIEW M ON M.PRODUCT_ID = P.IT WHERE P.ID = #{ID}")
	//public List<ProductDto> getReviewById(Long id);
	...
	@Insert("INSERT INTO PRODUCT_PRICE (ID, PRODUCT_ID, LIST_PRICE, SALES_PRICE) VALUES (PRICE_SEQ.nextval, #{productId}, #{listPrice}, #{salesPrice}) ")
